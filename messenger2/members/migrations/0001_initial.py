    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_read_message', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='message.Message', verbose_name='Последнее прочитанное сообщение')),
            ],
        ),
    ]
